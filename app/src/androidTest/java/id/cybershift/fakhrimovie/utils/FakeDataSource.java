...
public class FakeDataSource {
    ...
    public static ArrayList<MovieEntity> getMoviesData() {
    ...
    public static ArrayList<TVShowEntity> getTVShowsData() {
    ...
    public static MovieEntity getMovie(int position) {
        return getMoviesData().get(position);
    }

    public static TVShowEntity getTVShow(int position) {
        return getTVShowsData().get(position);
    }
}
